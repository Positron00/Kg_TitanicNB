...
# %% auto 0
__all__ = ['dataPath', 'train_data', 'test_data', 'meanAgeByClass', 'meanFareByClass', 'sex', 'embark', 'run', 'artifact',
           'impute_age', 'impute_fare']
...
# %% ../nbs/01_TitanicDataset.ipynb 16
meanFareByClass = train_data.groupby("Pclass")["Fare"].mean()

# %% ../nbs/01_TitanicDataset.ipynb 17
...
# %% ../nbs/01_TitanicDataset.ipynb 18
...
# %% ../nbs/01_TitanicDataset.ipynb 25
...
# %% ../nbs/01_TitanicDataset.ipynb 27
wandb.login() # log in Weights and Biases to upload and log data

# %% ../nbs/01_TitanicDataset.ipynb 28
